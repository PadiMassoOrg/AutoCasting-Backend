...
Estos Términos y Condiciones regulan el acceso y uso de Autocasting (la "Plataforma"), incluyendo el sitio web y la aplicación móvil de Autocasting. Al registrarte, iniciar sesión o utilizar la Plataforma, declarás que leíste y aceptaste estos términos. Si no estás de acuerdo, debés abstenerte de usarla.

## 1. Identificación del proveedor

El servicio es prestado por **Matias Sebastián Di Masso**, CUIT/CUIL **20-35257739-2**, con domicilio legal en **11 de Septiembre 4431, CABA** (en adelante, **"Autocasting"**, **"nosotros"** o **"la Plataforma"**).
...
Esta Política de Privacidad describe cómo Autocasting recopila, usa, almacena, comparte y protege los datos personales de quienes utilizan la Plataforma, incluyendo el sitio web y la aplicación móvil de Autocasting.

## 1. Responsable del tratamiento

El responsable de la base de datos y del tratamiento es **Matias Sebastián Di Masso**, CUIT/CUIL **20-35257739-2**, con domicilio legal en **11 de Septiembre 4431, CABA**.
...
## 11. Cookies, almacenamiento local y tecnologías equivalentes

Utilizamos cookies, almacenamiento local, almacenamiento seguro del dispositivo y tecnologías equivalentes, tanto en el sitio web como en la aplicación móvil de Autocasting, para autenticación, mantenimiento de sesión, seguridad, preferencias y funcionamiento técnico general de la Plataforma.

En el sitio web, podés configurar tu navegador para bloquear cookies, aunque esto puede afectar funcionalidades. En la aplicación móvil, este almacenamiento cumple una función equivalente a la de las cookies del sitio web (por ejemplo, mantener tu sesión iniciada de forma segura) y es necesario para el funcionamiento de la app; podés eliminarlo desinstalando la aplicación o borrando sus datos desde la configuración de tu dispositivo.
